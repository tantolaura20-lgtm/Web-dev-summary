...
What i learned:
CSS (Cascading Style Sheets) is the language used to style HTML elements — colors, layout, fonts, spacing, and more. You can write CSS in external files, internal <style> blocks, or inline.
...
What i learned:
You can control text color, alignment, decoration, transformation (uppercase/lowercase), and spacing.
...
What i learned:
You can specify font family, size, weight, and style for text.
